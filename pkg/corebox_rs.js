...
export class CoreGame {
    ...
    debug_time_info() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.coregame_debug_time_info(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    debug_power_info() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.coregame_debug_power_info(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    debug_rebel_info() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.coregame_debug_rebel_info(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
